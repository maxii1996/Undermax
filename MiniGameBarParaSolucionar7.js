...
(() => {
    ...
    Scene_Map.prototype.createBarArrowGame = function(gameConfig) {
        ...
        if (gameConfig.positionMode === "Automatic") {
            ...
            console.log("Original Bar X:", gameConfig.barX);
            console.log("Original Bar Y:", gameConfig.barY);
            console.log("AutoBarOffsetX:", gameConfig.AutoBarOffsetX);
            console.log("AutoBarOffsetY:", gameConfig.AutoBarOffsetY);
            ...
            console.log("Adjusted Bar X:", gameConfig.barX);
            console.log("Adjusted Bar Y:", gameConfig.barY);
        }
        ...
        if (gameConfig.customText && gameConfig.customText !== "") {
            ...
            console.log("Custom Text not provided or empty.");
        }
    ...
    Scene_Map.prototype.endBarArrowGame = function() {
        ...
        if (this._customTextWindow) {
            this._customTextWindow.hideWindow(); // Oculta la ventana y limpia su contenido
            this.removeChild(this._customTextWindow);
            this._customTextWindow.destroy(); // Destruye la ventana y libera sus recursos
